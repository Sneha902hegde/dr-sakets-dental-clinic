...
export default function ContactHero() {
  ...
  return (
    <section
      ...
      aria-label="Contact & Book Appointment"
    >
      ...
      <div className="container-page relative text-center">
        ...
        <motion.h1
          className="mx-auto mt-5 max-w-3xl text-4xl font-extrabold leading-[1.12] tracking-tight text-ink-900 sm:text-5xl lg:text-6xl"
