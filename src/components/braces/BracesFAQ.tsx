...
import { bracesFaqs } from '../../data/treatments';
...
export default function BracesFAQ() {
  ...
  return (
    <Section
      id="faq"
      eyebrow="FAQ"
      title="Your braces questions, answered"
      subtitle="The answers patients ask us most. If yours isn't here, just reach out — we're happy to help."
      className="bg-ink-50"
    >
      ...
      <div className="mt-10 text-center">
        <button onClick={() => toSection('#book')} className="btn-primary">
          Still have a question? Ask Dr. Saket
        </button>
      </div>
    </Section>
  );
