...
import { bracesCta } from '../../data/treatments';

export default function BracesCTA() {
      ...
      <div className="container-page relative">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          >
            ...
            <a
              href={whatsappLink("Hello! I'd like to book an orthodontic consultation at Dr. Saket's Dental Clinic.")}
              target="_blank"
